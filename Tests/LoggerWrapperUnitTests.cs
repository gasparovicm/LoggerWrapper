...
namespace idevUnitTests.Log
{
    ...
    public class LoggerWrapperUnitTests
    {
        ...
        private static ILogger log4Net;
        [OneTimeSetUp]
        public void FirstSetUp()
        {
            loggerMock = CreateLoggerMockWithMethods();
            log4Net = new TestLogger("test");
        }
        ...
        [Test]
        public void Logger_CreateFromILoggerLog4Net_FatalMethodsTest()
        {
            //Arrange
            var testMessage = Guid.NewGuid().ToString();
            var testException = new Exception(Guid.NewGuid().ToString());
        ...
        #endregion Logger_CreateFromILogger

        #region CreateFrom ILoggger
        [Test]
        public void Logger_CreateFromILogger_DebugMethodsTest()
        {
            //Arrange
            var testMessage = Guid.NewGuid().ToString();
            var testException = new Exception(Guid.NewGuid().ToString());
